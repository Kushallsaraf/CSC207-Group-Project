...
public class Constants {
    ...
    public static final String INVALID_PASSWORD = "passwords should be 10-20 characters long with no spaces in between";
    ...
    public static final String FILE_PATH = "src/main/java/UserAuthentication/users.json";
}
