...
public class Constants {
    ...
    public static final String USERNAME_TAKEN = "This Username is Already in Use";

    public static final String FAILED_LOGIN_USERNAME = "User Does Not Exist!";

    public static final String FAILED_LOGIN_PASSWORD = "Incorrect Password. Please try again.";
